                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      16.0, 4.0, 10.0, 0.0),
                                  child: Text(
                                    'A continuacion se presentan los detalles de su orden, en breve recibira una copia por email.',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Inter',
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(0.0, 8.0, 0.0, 0.0),
                                              child: Text(
                                                'Su pedido se procesara en 1 a 2 dias laborales, si la direccion de entrega es fuera del GAM se procesara en 3 a 4 dias',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyLarge
                                                        .override(
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  12.0),
                                                      child: Text(
                                                        'Dudas o consultas con su pedido contactenos:',
