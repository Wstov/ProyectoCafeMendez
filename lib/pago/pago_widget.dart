...
class _PagoWidgetState extends State<PagoWidget> {
  ...
  void initState() {
    ...
    _model.linea1TextController ??=
        TextEditingController(text: 'Nombre Condominio, Residencial, etc....');
    _model.linea1FocusNode ??= FocusNode();

    _model.linea2TextController ??=
        TextEditingController(text: 'Numero de piso, casa, apartamento');
    _model.linea2FocusNode ??= FocusNode();

    _model.provinciaTextController ??= TextEditingController();
    _model.provinciaFocusNode ??= FocusNode();

    _model.cantonTextController ??= TextEditingController();
    _model.cantonFocusNode ??= FocusNode();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            controller: _model.linea1TextController,
                            focusNode: _model.linea1FocusNode,
                            autofocus: false,
                            obscureText: false,
                            ...
                            minLines: 1,
                            validator: _model.linea1TextControllerValidator
                                .asValidator(context),
                          ),
                          TextFormField(
                            controller: _model.linea2TextController,
                            focusNode: _model.linea2FocusNode,
                            autofocus: false,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: 'Linea 2',
                            ...
                            validator: _model.linea2TextControllerValidator
                                .asValidator(context),
                          ),
                          TextFormField(
                            ...
                            validator: _model.provinciaTextControllerValidator
                                .asValidator(context),
                          ),
                          TextFormField(
                            controller: _model.cantonTextController,
                            focusNode: _model.cantonFocusNode,
                            autofocus: false,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: 'Cantón',
                            ...
                            minLines: 1,
                            keyboardType: TextInputType.phone,
                            validator: _model.cantonTextControllerValidator
                                .asValidator(context),
                          ),
                          TextFormField(
                            ...
                            minLines: 1,
                            keyboardType: TextInputType.phone,
                            validator: _model.distritoTextControllerValidator
                                .asValidator(context),
                          ),
                          TextFormField(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await PagoRecord.collection
                          .doc()
                          .set(createPagoRecordData(
                            linea1: _model.linea1TextController.text,
                            linea2: _model.linea2TextController.text,
                            provincia: _model.provinciaTextController.text,
                            canton: _model.cantonTextController.text,
                            distrito: _model.distritoTextController.text,
                            zip: int.tryParse(_model.zipTextController.text),
                            nombreComp: _model.nombreTextController.text,
                            email: _model.emailTextController.text,
                            telefono: int.tryParse(
                                _model.telefonoTextController.text),
                            facturaID: random_data.randomInteger(0, 100),
                          ));

                      context.pushNamed('confirmacionPago');
                    },
                    text: 'Confirmar Pago',
